...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="relative min-h-[calc(100vh-5rem)] mt-20 flex items-center justify-center overflow-hidden bg-white dark:bg-gray-950 px-6 py-12 border-t border-gray-100 dark:border-gray-900">
        {/* Optimized Glow */}
